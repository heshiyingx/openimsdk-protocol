...
const (
	...
	Third_UploadImgPreSign_FullMethodName        = "/OpenIMServer.third.third/UploadImgPreSign"
	Third_UploadImgCompleted_FullMethodName      = "/OpenIMServer.third.third/UploadImgCompleted"
)
...
func (c *thirdClient) UploadImgPreSign(ctx context.Context, in *UploadImgPreSignReq, opts ...grpc.CallOption) (*UploadImgPreSignResp, error) {
	out := new(UploadImgPreSignResp)
	err := c.cc.Invoke(ctx, Third_UploadImgPreSign_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Third_UploadImgPreSign_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UploadImgPreSignReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ThirdServer).UploadImgPreSign(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Third_UploadImgPreSign_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ThirdServer).UploadImgPreSign(ctx, req.(*UploadImgPreSignReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Third_UploadImgCompleted_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(ThirdServer).UploadImgCompleted(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var Third_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UploadImgPreSign",
			Handler:    _Third_UploadImgPreSign_Handler,
		},
		{
			MethodName: "UploadImgCompleted",
			Handler:    _Third_UploadImgCompleted_Handler,
		},
	},
