...
type PinMsgReq struct {
	...
	Type             uint32 `protobuf:"varint,1,opt,name=type,proto3" json:"type"`                         // 1.消息置顶，2消息取消置顶
	ConversationID   string `protobuf:"bytes,2,opt,name=conversationID,proto3" json:"conversationID"`      // 会话id
	Seq              int64  `protobuf:"varint,3,opt,name=seq,proto3" json:"seq"`                           // 消息seq
	SenderPlatformID int32  `protobuf:"varint,4,opt,name=senderPlatformID,proto3" json:"senderPlatformID"` //平台ID
	GroupID          string `protobuf:"bytes,5,opt,name=groupID,proto3" json:"groupID"`                    // 群id
}
...
type QueryPinMsgReq struct {
	...
	Page           int64  `protobuf:"varint,2,opt,name=page,proto3" json:"page"`                    // 默认为1
	ShowNum        int64  `protobuf:"varint,3,opt,name=showNum,proto3" json:"showNum"`              // 默认为10，最大20
}
...
type PinMessage struct {
	...
	Msg     *sdkws.MsgData  `protobuf:"bytes,1,opt,name=msg,proto3" json:"msg"`         // 置顶的源消息
	PinUser *sdkws.UserInfo `protobuf:"bytes,2,opt,name=pinUser,proto3" json:"pinUser"` //操作者
	Type    uint32          `protobuf:"varint,3,opt,name=type,proto3" json:"type"`      // 1.消息置顶，2消息取消置顶
}
