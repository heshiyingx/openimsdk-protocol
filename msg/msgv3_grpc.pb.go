...
const (
	...
	Msg_PinMsg_FullMethodName                           = "/OpenIMServer.msg.msg/PinMsg"
	Msg_QueryMsgPin_FullMethodName                      = "/OpenIMServer.msg.msg/QueryMsgPin"
)
...
type MsgClient interface {
	...
	PinMsg(ctx context.Context, in *PinMsgReq, opts ...grpc.CallOption) (*PinMsgResp, error)
	QueryMsgPin(ctx context.Context, in *QueryPinMsgReq, opts ...grpc.CallOption) (*QueryPinMsgResp, error)
}
...
func (c *msgClient) PinMsg(ctx context.Context, in *PinMsgReq, opts ...grpc.CallOption) (*PinMsgResp, error) {
	out := new(PinMsgResp)
	err := c.cc.Invoke(ctx, Msg_PinMsg_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) QueryMsgPin(ctx context.Context, in *QueryPinMsgReq, opts ...grpc.CallOption) (*QueryPinMsgResp, error) {
	out := new(QueryPinMsgResp)
	err := c.cc.Invoke(ctx, Msg_QueryMsgPin_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	PinMsg(context.Context, *PinMsgReq) (*PinMsgResp, error)
	QueryMsgPin(context.Context, *QueryPinMsgReq) (*QueryPinMsgResp, error)
...
func (UnimplementedMsgServer) PinMsg(context.Context, *PinMsgReq) (*PinMsgResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PinMsg not implemented")
}
func (UnimplementedMsgServer) QueryMsgPin(context.Context, *QueryPinMsgReq) (*QueryPinMsgResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method QueryMsgPin not implemented")
}
...
func _Msg_PinMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PinMsgReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).PinMsg(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_PinMsg_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).PinMsg(ctx, req.(*PinMsgReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Msg_QueryMsgPin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryPinMsgReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).QueryMsgPin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_QueryMsgPin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).QueryMsgPin(ctx, req.(*QueryPinMsgReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Msg_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PinMsg",
			Handler:    _Msg_PinMsg_Handler,
		},
		{
			MethodName: "QueryMsgPin",
			Handler:    _Msg_QueryMsgPin_Handler,
		},
	},
